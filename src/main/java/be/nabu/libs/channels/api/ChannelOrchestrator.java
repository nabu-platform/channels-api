...
public interface ChannelOrchestrator {
	...
	public void recover(ProviderResolver<ChannelProvider<?>> provider, Date from, ChannelRecoverySelector selector, ChannelResultHandler resultHandler) throws IOException;
}
